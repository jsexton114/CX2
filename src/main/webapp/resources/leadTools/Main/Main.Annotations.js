    ...
    (function (DocumentViewerDemo) {
        ...
        var AnnotationsPart = (function () {
            ...
            AnnotationsPart.prototype.bindElements = function () {
                ...
                currentIndex = this._mainApp.commandsBinder.elements.push(new DocumentViewerDemo.CommandBinderElement()) - 1;
                this._mainApp.commandsBinder.elements[currentIndex].commandName = lt.Documents.UI.DocumentViewerCommands.annotationsUserModeRun;
                this._mainApp.commandsBinder.elements[currentIndex].userInterfaceElement = $(this.headerToolbar_AnnotationsMenu.userModeMenuItems.runModeMenuItem);
                this._mainApp.commandsBinder.elements[currentIndex].updateChecked = true;
                currentIndex = this._mainApp.commandsBinder.elements.push(new DocumentViewerDemo.CommandBinderElement()) - 1;
                this._mainApp.commandsBinder.elements[currentIndex].commandName = lt.Documents.UI.DocumentViewerCommands.annotationsUserModeDesign;
                this._mainApp.commandsBinder.elements[currentIndex].userInterfaceElement = $(this.headerToolbar_AnnotationsMenu.userModeMenuItems.designModeMenuItem);
                this._mainApp.commandsBinder.elements[currentIndex].updateChecked = true;
                currentIndex = this._mainApp.commandsBinder.elements.push(new DocumentViewerDemo.CommandBinderElement()) - 1;
                this._mainApp.commandsBinder.elements[currentIndex].commandName = lt.Documents.UI.DocumentViewerCommands.annotationsUserModeRender;
                this._mainApp.commandsBinder.elements[currentIndex].userInterfaceElement = $(this.headerToolbar_AnnotationsMenu.userModeMenuItems.renderModeMenuItem);
                this._mainApp.commandsBinder.elements[currentIndex].updateChecked = true;
                currentIndex = this._mainApp.commandsBinder.elements.push(new DocumentViewerDemo.CommandBinderElement()) - 1;
                this._mainApp.commandsBinder.elements[currentIndex].commandName = lt.Documents.UI.DocumentViewerCommands.annotationsBringToFront;
                this._mainApp.commandsBinder.elements[currentIndex].userInterfaceElement = $(this.headerToolbar_AnnotationsMenu.bringToFrontMenuItem);
                currentIndex = this._mainApp.commandsBinder.elements.push(new DocumentViewerDemo.CommandBinderElement()) - 1;
                this._mainApp.commandsBinder.elements[currentIndex].commandName = lt.Documents.UI.DocumentViewerCommands.annotationsSendToBack;
                this._mainApp.commandsBinder.elements[currentIndex].userInterfaceElement = $(this.headerToolbar_AnnotationsMenu.sendToBackMenuItem);
                currentIndex = this._mainApp.commandsBinder.elements.push(new DocumentViewerDemo.CommandBinderElement()) - 1;
                this._mainApp.commandsBinder.elements[currentIndex].commandName = lt.Documents.UI.DocumentViewerCommands.annotationsBringToFirst;
                this._mainApp.commandsBinder.elements[currentIndex].userInterfaceElement = $(this.headerToolbar_AnnotationsMenu.bringToFirstMenuItem);
                currentIndex = this._mainApp.commandsBinder.elements.push(new DocumentViewerDemo.CommandBinderElement()) - 1;
                this._mainApp.commandsBinder.elements[currentIndex].commandName = lt.Documents.UI.DocumentViewerCommands.annotationsSendToLast;
                this._mainApp.commandsBinder.elements[currentIndex].userInterfaceElement = $(this.headerToolbar_AnnotationsMenu.sendToLastMenuItem);
                currentIndex = this._mainApp.commandsBinder.elements.push(new DocumentViewerDemo.CommandBinderElement()) - 1;
                this._mainApp.commandsBinder.elements[currentIndex].commandName = lt.Documents.UI.DocumentViewerCommands.annotationsFlip;
                this._mainApp.commandsBinder.elements[currentIndex].userInterfaceElement = $(this.headerToolbar_AnnotationsMenu.verticalFlipMenuItem);
                currentIndex = this._mainApp.commandsBinder.elements.push(new DocumentViewerDemo.CommandBinderElement()) - 1;
                this._mainApp.commandsBinder.elements[currentIndex].commandName = lt.Documents.UI.DocumentViewerCommands.annotationsReverse;
                this._mainApp.commandsBinder.elements[currentIndex].userInterfaceElement = $(this.headerToolbar_AnnotationsMenu.horizontalFlipMenuItem);
                currentIndex = this._mainApp.commandsBinder.elements.push(new DocumentViewerDemo.CommandBinderElement()) - 1;
                this._mainApp.commandsBinder.elements[currentIndex].commandName = lt.Documents.UI.DocumentViewerCommands.annotationsGroup;
                this._mainApp.commandsBinder.elements[currentIndex].userInterfaceElement = $(this.headerToolbar_AnnotationsMenu.groupSelectedObjectsMenuItem);
                currentIndex = this._mainApp.commandsBinder.elements.push(new DocumentViewerDemo.CommandBinderElement()) - 1;
                this._mainApp.commandsBinder.elements[currentIndex].commandName = lt.Documents.UI.DocumentViewerCommands.annotationsUngroup;
                this._mainApp.commandsBinder.elements[currentIndex].userInterfaceElement = $(this.headerToolbar_AnnotationsMenu.ungroupMenuItem);
                currentIndex = this._mainApp.commandsBinder.elements.push(new DocumentViewerDemo.CommandBinderElement()) - 1;
                this._mainApp.commandsBinder.elements[currentIndex].commandName = lt.Documents.UI.DocumentViewerCommands.annotationsLock;
                this._mainApp.commandsBinder.elements[currentIndex].userInterfaceElement = $(this.headerToolbar_AnnotationsMenu.lockObjectMenuItem);
                this._mainApp.commandsBinder.elements[currentIndex].autoRun = false;
                currentIndex = this._mainApp.commandsBinder.elements.push(new DocumentViewerDemo.CommandBinderElement()) - 1;
                this._mainApp.commandsBinder.elements[currentIndex].commandName = lt.Documents.UI.DocumentViewerCommands.annotationsUnlock;
                this._mainApp.commandsBinder.elements[currentIndex].userInterfaceElement = $(this.headerToolbar_AnnotationsMenu.unlockObjectMenuItem);
                this._mainApp.commandsBinder.elements[currentIndex].autoRun = false;
                currentIndex = this._mainApp.commandsBinder.elements.push(new DocumentViewerDemo.CommandBinderElement()) - 1;
                this._mainApp.commandsBinder.elements[currentIndex].commandName = lt.Documents.UI.DocumentViewerCommands.annotationsResetRotatePoints;
                this._mainApp.commandsBinder.elements[currentIndex].userInterfaceElement = $(this.headerToolbar_AnnotationsMenu.resetRotatePointMenuItem);
                currentIndex = this._mainApp.commandsBinder.elements.push(new DocumentViewerDemo.CommandBinderElement()) - 1;
                this._mainApp.commandsBinder.elements[currentIndex].commandName = lt.Documents.UI.DocumentViewerCommands.annotationsProperties;
                this._mainApp.commandsBinder.elements[currentIndex].userInterfaceElement = $(this.headerToolbar_AnnotationsMenu.annotationsPropertiesMenuItem);
                currentIndex = this._mainApp.commandsBinder.elements.push(new DocumentViewerDemo.CommandBinderElement()) - 1;
                this._mainApp.commandsBinder.elements[currentIndex].commandName = lt.Documents.UI.DocumentViewerCommands.annotationsUseRotateThumbs;
                this._mainApp.commandsBinder.elements[currentIndex].userInterfaceElement = $(this.headerToolbar_AnnotationsMenu.useRotateThumbMenuItem);
                this._mainApp.commandsBinder.elements[currentIndex].updateChecked = true;
                currentIndex = this._mainApp.commandsBinder.elements.push(new DocumentViewerDemo.CommandBinderElement()) - 1;
                this._mainApp.commandsBinder.elements[currentIndex].commandName = lt.Documents.UI.DocumentViewerCommands.annotationsRenderOnThumbnails;
            ...
            AnnotationsPart.prototype.window_keydown = function (e) {
                ...
                if (e.keyCode == 46) {
                    ...
                    // Check if there is open dialog
                    for (var i = 0; i < demoDialogs.length; i++) {
                        hasOpenDialog = demoDialogs[i].getAttribute("aria-hidden") == "false";
                        if (hasOpenDialog)
                            break;
                    }
                    if (!hasOpenDialog) {
