        ...
        var EditPart = (function () {
            ...
            EditPart.prototype.bindElements = function () {
                ...
                if (this._mainApp.demoMode != DocumentViewerDemo.DemoMode.Barcode) {
                    ...
                    this._mainApp.commandsBinder.elements[currentIndex].userInterfaceElement = $(this.headerToolbar_EditMenu.editMenuItem);
                ...
                if (this._mainApp.demoMode == DocumentViewerDemo.DemoMode.Default) {
                    currentIndex = this._mainApp.commandsBinder.elements.push(new DocumentViewerDemo.CommandBinderElement()) - 1;
                    this._mainApp.commandsBinder.elements[currentIndex].commandName = lt.Documents.UI.DocumentViewerCommands.annotationsUndo;
                    this._mainApp.commandsBinder.elements[currentIndex].userInterfaceElement = $(this.headerToolbar_EditMenu.undoMenuItem);
                    currentIndex = this._mainApp.commandsBinder.elements.push(new DocumentViewerDemo.CommandBinderElement()) - 1;
                    this._mainApp.commandsBinder.elements[currentIndex].commandName = lt.Documents.UI.DocumentViewerCommands.annotationsRedo;
                    this._mainApp.commandsBinder.elements[currentIndex].userInterfaceElement = $(this.headerToolbar_EditMenu.redoMenuItem);
                    currentIndex = this._mainApp.commandsBinder.elements.push(new DocumentViewerDemo.CommandBinderElement()) - 1;
                    this._mainApp.commandsBinder.elements[currentIndex].commandName = lt.Documents.UI.DocumentViewerCommands.annotationsDelete;
                    this._mainApp.commandsBinder.elements[currentIndex].userInterfaceElement = $(this.headerToolbar_EditMenu.deleteAnnotationMenuItem);
                    currentIndex = this._mainApp.commandsBinder.elements.push(new DocumentViewerDemo.CommandBinderElement()) - 1;
                    this._mainApp.commandsBinder.elements[currentIndex].commandName = lt.Documents.UI.DocumentViewerCommands.annotationsSelectAll;
                    this._mainApp.commandsBinder.elements[currentIndex].userInterfaceElement = $(this.headerToolbar_EditMenu.selectAllAnnotationsMenuItem);
                }
                currentIndex = this._mainApp.commandsBinder.elements.push(new DocumentViewerDemo.CommandBinderElement()) - 1;
                this._mainApp.commandsBinder.elements[currentIndex].commandName = lt.Documents.UI.DocumentViewerCommands.textSelectAll;
                this._mainApp.commandsBinder.elements[currentIndex].userInterfaceElement = $(this.headerToolbar_EditMenu.selectAllTextMenuItem);
                this._mainApp.commandsBinder.elements[currentIndex].autoRun = false;
                currentIndex = this._mainApp.commandsBinder.elements.push(new DocumentViewerDemo.CommandBinderElement()) - 1;
                this._mainApp.commandsBinder.elements[currentIndex].commandNames = new Array(lt.Documents.UI.DocumentViewerCommands.textClearSelection, lt.Documents.UI.DocumentViewerCommands.annotationsClearSelection);
                this._mainApp.commandsBinder.elements[currentIndex].userInterfaceElement = $(this.headerToolbar_EditMenu.clearSelectionMenuItem);
                currentIndex = this._mainApp.commandsBinder.elements.push(new DocumentViewerDemo.CommandBinderElement()) - 1;
                this._mainApp.commandsBinder.elements[currentIndex].commandName = lt.Documents.UI.DocumentViewerCommands.textCopy;
                this._mainApp.commandsBinder.elements[currentIndex].userInterfaceElement = $(this.headerToolbar_EditMenu.copyTextMenuItem);
                this._mainApp.commandsBinder.elements[currentIndex].autoRun = false;
                currentIndex = this._mainApp.commandsBinder.elements.push(new DocumentViewerDemo.CommandBinderElement()) - 1;
                this._mainApp.commandsBinder.elements[currentIndex].userInterfaceElement = $(this.headerToolbar_EditMenu.findTextMenuItem);
                this._mainApp.commandsBinder.elements[currentIndex].autoRun = false;
            };
                ...
                if (!this._mainApp.documentViewer.text.hasDocumentPageText(this._currentPage)) {
                    ...
                    if (!found) {
                        ...
                        if ((this._currentPage < 1 || this._currentPage > this._mainApp.documentViewer.pageCount) || !this._gotoNextPage) {
                            ...
                            this._currentPage = 1;
                            window.alert("Finished searching. No more results found");
                            return;
                        }
                        this.findText();
                    }
