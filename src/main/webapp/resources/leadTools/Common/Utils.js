    ...
    (function(Utils) {
        ...
        var ServiceHelper = (function() {
            ...
            Object.defineProperty(ServiceHelper, "serviceHost", {
                get: function() {
                    return ServiceHelper._serviceHost;
                },
                set: function(value) {
            ...
            Object.defineProperty(ServiceHelper, "servicePath", {
                get: function() {
                    return ServiceHelper._servicePath;
                },
                set: function(value) {
            ...
            Object.defineProperty(ServiceHelper, "serviceApiPath", {
                get: function() {
                    return ServiceHelper._serviceApiPath;
                },
                set: function(value) {
            ...
            Object.defineProperty(ServiceHelper, "serviceUri", {
                get: function() {
                    return ServiceHelper._serviceUri;
                },
                enumerable: true,
                configurable: true
            });
            ...
            Object.defineProperty(ServiceHelper, "serviceTestResource", {
                get: function() {
                    return ServiceHelper._serviceTestResource;
                },
                set: function(value) {
            ...
            DemoHelper.touchScroll = function(div) {
                if (DemoHelper.isTouchDevice()) {
                    div.addEventListener('touchstart', function(e) {
                        return DemoHelper.touchScrollStart(e);
                    }, false);
                    div.addEventListener('touchmove', function(e) {
                        return DemoHelper.touchScrollMove(e);
                    }, false);
                }
            };
