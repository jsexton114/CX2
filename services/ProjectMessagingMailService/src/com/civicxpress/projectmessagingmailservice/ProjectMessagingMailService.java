...
package com.civicxpress.projectmessagingmailservice;
 ...
 */
@ExposeToClient
public class ProjectMessagingMailService {

    private static final Logger logger = LoggerFactory.getLogger(ProjectMessagingMailService.class);
     ...
     */
  public String sendMessagingMail(String sender,String comments,String recipient,String municipality,String municipalitySignature,String projectTitle,String projectLink) throws MessagingException {
     ...
     ArrayList recipientList= new ArrayList(Arrays.asList(recipient.split(",")));
        ...
        String emailSubject="New Message on CivicXpress Project "+projectTitle;
        
        String projectURL= projectLink;
        logger.info(projectLink);
        
        String emailContent = "You have been tagged by "+sender+" on the following message (on "+municipality+" project ";
        emailContent = emailContent+"<a href ='"+projectURL+"'>"+projectTitle+"</a>):";
