...
public class UserPasswordResetTokensController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
	public Page<Map<String, Object>> getUserPasswordResetTokensAggregatedValues(@RequestBody AggregationInfo aggregationInfo, Pageable pageable) {
        LOGGER.debug("Fetching aggregated results for {}", aggregationInfo);
        return userPasswordResetTokensService.getAggregatedValues(aggregationInfo, pageable);
    }
