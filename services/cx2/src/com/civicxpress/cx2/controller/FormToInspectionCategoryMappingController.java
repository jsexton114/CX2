...
public class FormToInspectionCategoryMappingController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
	public Page<Map<String, Object>> getFormToInspectionCategoryMappingAggregatedValues(@RequestBody AggregationInfo aggregationInfo, Pageable pageable) {
        LOGGER.debug("Fetching aggregated results for {}", aggregationInfo);
        return formToInspectionCategoryMappingService.getAggregatedValues(aggregationInfo, pageable);
    }
