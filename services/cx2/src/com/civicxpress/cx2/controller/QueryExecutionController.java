...
public class QueryExecutionController {
    ...
    public int executeAddingVendorsToForm(@RequestParam(value = "RelatedFormGUID", required = false) java.lang.String RelatedFormGUID, @RequestParam(value = "SharedOn", required = false) java.sql.Timestamp SharedOn, @RequestParam(value = "VendorId", required = false) java.lang.Integer VendorId) throws QueryParameterMismatchException {
        ...
        int result = queryService.executeAddingVendorsToForm(RelatedFormGUID, SharedOn, VendorId);
        LOGGER.debug("got the result of named query {}", result);
        return result;
    }
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Object> executeCompanyFormsByVendorId(@RequestParam(value = "closed", required = false) java.lang.Boolean closed, @RequestParam(value = "vendorId", required = false) java.lang.Integer vendorId, Pageable pageable) throws QueryParameterMismatchException {
        LOGGER.debug("Executing named query CompanyFormsByVendorId");
        Page<Object> result = queryService.executeCompanyFormsByVendorId(pageable, closed, vendorId);
        LOGGER.debug("got the result of named query {}", result);
        return result;
    }
    ...
    public Page<Object> executeCountOfCompnayFormsByVendorId(@RequestParam(value = "closed", required = false) java.lang.Boolean closed, @RequestParam(value = "vendorId", required = false) java.lang.Integer vendorId, Pageable pageable) throws QueryParameterMismatchException {
        ...
        Page<Object> result = queryService.executeCountOfCompnayFormsByVendorId(pageable, closed, vendorId);
        LOGGER.debug("got the result of named query {}", result);
        return result;
    }
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Object> executeCountOfProcessFormsByMuncipality(@RequestParam(value = "MunicipalityId", required = false) java.lang.Integer MunicipalityId, @RequestParam(value = "closed", required = false) java.lang.Boolean closed, @RequestParam(value = "UserId", required = false) java.lang.Integer UserId, Pageable pageable) throws QueryParameterMismatchException {
        LOGGER.debug("Executing named query CountOfProcessFormsByMuncipality");
        Page<Object> result = queryService.executeCountOfProcessFormsByMuncipality(pageable, MunicipalityId, closed, UserId);
        LOGGER.debug("got the result of named query {}", result);
        return result;
    }
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Object> executeGetFormTypeFieldsByTypeId(@RequestParam(value = "formTypeId", required = false) java.lang.Long formTypeId, Pageable pageable) throws QueryParameterMismatchException {
        LOGGER.debug("Executing named query getFormTypeFieldsByTypeId");
        Page<Object> result = queryService.executeGetFormTypeFieldsByTypeId(pageable, formTypeId);
        LOGGER.debug("got the result of named query {}", result);
        return result;
    }
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Object> executeGetFormTypesByCategoriesAndMunicipalities(@RequestParam(value = "formCategory", required = false) java.lang.Integer formCategory, @RequestParam(value = "isActive", required = false) java.lang.Boolean isActive, @RequestParam(value = "userId", required = false) java.lang.Integer userId, Pageable pageable) throws QueryParameterMismatchException {
        LOGGER.debug("Executing named query GetFormTypesByCategoriesAndMunicipalities");
        Page<Object> result = queryService.executeGetFormTypesByCategoriesAndMunicipalities(pageable, formCategory, isActive, userId);
        LOGGER.debug("got the result of named query {}", result);
        return result;
    }
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Object> executeProcessFormsForUserByMunicipality(@RequestParam(value = "MunicipalityId", required = false) java.lang.Integer MunicipalityId, @RequestParam(value = "Closed", required = false) java.lang.Boolean Closed, @RequestParam(value = "UserId", required = false) java.lang.Integer UserId, Pageable pageable) throws QueryParameterMismatchException {
        LOGGER.debug("Executing named query ProcessFormsForUserByMunicipality");
        Page<Object> result = queryService.executeProcessFormsForUserByMunicipality(pageable, MunicipalityId, Closed, UserId);
        LOGGER.debug("got the result of named query {}", result);
        return result;
    }
    ...
    public int executeRecordFormHistory(@RequestParam(value = "FormGUID", required = false) java.lang.String FormGUID, @RequestParam(value = "FormTypeId", required = false) java.lang.Integer FormTypeId, @RequestParam(value = "NewStatusId", required = false) java.lang.Integer NewStatusId, @RequestParam(value = "OldStatusId", required = false) java.lang.Integer OldStatusId, @RequestParam(value = "Comments", required = false) java.lang.String Comments, @RequestParam(value = "CreatedBy", required = false) java.lang.Integer CreatedBy) throws QueryParameterMismatchException {
        ...
        int result = queryService.executeRecordFormHistory(FormGUID, FormTypeId, NewStatusId, OldStatusId, Comments, CreatedBy);
        LOGGER.debug("got the result of named query {}", result);
        return result;
    }
