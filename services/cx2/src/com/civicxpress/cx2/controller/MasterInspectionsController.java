...
public class MasterInspectionsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
	public Page<Map<String, Object>> getMasterInspectionsAggregatedValues(@RequestBody AggregationInfo aggregationInfo, Pageable pageable) {
        LOGGER.debug("Fetching aggregated results for {}", aggregationInfo);
        return masterInspectionsService.getAggregatedValues(aggregationInfo, pageable);
    }
    ...
    public Page<Fees> findAssociatedFeeses(@PathVariable("id") String id, Pageable pageable) {
        ...
        return masterInspectionsService.findAssociatedFeeses(id, pageable);
    }
    ...
    public Page<FormMessages> findAssociatedFormMessageses(@PathVariable("id") String id, Pageable pageable) {
        ...
        return masterInspectionsService.findAssociatedFormMessageses(id, pageable);
    }
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<InspectionDraft> findAssociatedInspectionDrafts(@PathVariable("id") String id, Pageable pageable) {

        LOGGER.debug("Fetching all associated inspectionDrafts");
        return masterInspectionsService.findAssociatedInspectionDrafts(id, pageable);
    }
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<InspectionHistory> findAssociatedInspectionHistories(@PathVariable("id") String id, Pageable pageable) {

        LOGGER.debug("Fetching all associated inspectionHistories");
        return masterInspectionsService.findAssociatedInspectionHistories(id, pageable);
    }
    ...
    public Page<MasterCases> findAssociatedMasterCaseses(@PathVariable("id") String id, Pageable pageable) {
        ...
        return masterInspectionsService.findAssociatedMasterCaseses(id, pageable);
    }
    ...
    public Page<Violations> findAssociatedViolationses(@PathVariable("id") String id, Pageable pageable) {
        ...
        return masterInspectionsService.findAssociatedViolationses(id, pageable);
    }
