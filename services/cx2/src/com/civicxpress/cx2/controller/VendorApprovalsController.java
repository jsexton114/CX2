...
public class VendorApprovalsController {
    ...
    public VendorApprovals getByMunicipalityIdAndVendorId(@RequestParam(name = "municipalityId") Integer municipalityId, @RequestParam(name = "vendorId") Integer vendorId) {
