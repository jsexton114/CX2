...
public class GisrecordsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
	public Page<Map<String, Object>> getGisrecordsAggregatedValues(@RequestBody AggregationInfo aggregationInfo, Pageable pageable) {
        LOGGER.debug("Fetching aggregated results for {}", aggregationInfo);
        return gisrecordsService.getAggregatedValues(aggregationInfo, pageable);
    }
    ...
    public Page<FormMessages> findAssociatedFormMessageses(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return gisrecordsService.findAssociatedFormMessageses(id, pageable);
    }
