...
public class Cx2QueryExecutorServiceImpl implements Cx2QueryExecutorService {
    ...
    public Page<GetTransactionsByMunicipalityResponse> executeGetTransactionsByMunicipality(Integer municipalityId, LocalDateTime startd, LocalDateTime endd, Pageable pageable) {
        ...
        return queryExecutor.executeNamedQuery("getTransactionsByMunicipality", params, GetTransactionsByMunicipalityResponse.class, pageable);
    }
    ...
    public Downloadable exportGetTransactionsByMunicipality(ExportType exportType, Integer municipalityId, LocalDateTime startd, LocalDateTime endd, Pageable pageable) {
        ...
        return queryExecutor.exportNamedQueryData("getTransactionsByMunicipality", params, exportType, GetTransactionsByMunicipalityResponse.class, pageable);
    }
    ...
    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public Page<CounNewCasesAndAfterDateResponse> executeCounNewCasesAndAfterDate(Boolean codeEnforcement, Boolean closed, Integer municipalityId, Timestamp dateSubmitted, Pageable pageable) {
        ...
        return queryExecutor.executeNamedQuery("CounNewCasesAndAfterDate", params, CounNewCasesAndAfterDateResponse.class, pageable);
    }

    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public Downloadable exportCounNewCasesAndAfterDate(ExportType exportType, Boolean codeEnforcement, Boolean closed, Integer municipalityId, Timestamp dateSubmitted, Pageable pageable) {
        Map params = new HashMap(4);
        ...
        return queryExecutor.exportNamedQueryData("CounNewCasesAndAfterDate", params, exportType, CounNewCasesAndAfterDateResponse.class, pageable);
    }
    ...
    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public Page<MunicipalityIdsOfVendorResponse> executeMunicipalityIdsOfVendor(Integer vendor, Pageable pageable) {
        Map params = new HashMap(1);

        params.put("vendor", vendor);

        return queryExecutor.executeNamedQuery("MunicipalityIdsOfVendor", params, MunicipalityIdsOfVendorResponse.class, pageable);
    }

    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public Downloadable exportMunicipalityIdsOfVendor(ExportType exportType, Integer vendor, Pageable pageable) {
        Map params = new HashMap(1);

        params.put("vendor", vendor);

        return queryExecutor.exportNamedQueryData("MunicipalityIdsOfVendor", params, exportType, MunicipalityIdsOfVendorResponse.class, pageable);
    }
    ...
    public Page<OutcomeByDesignResponse> executeOutcomeByDesign(Integer inspectionDesign, String outcome, Pageable pageable) {
        ...
        params.put("inspectionDesign", inspectionDesign);
        params.put("outcome", outcome);

        return queryExecutor.executeNamedQuery("OutcomeByDesign", params, OutcomeByDesignResponse.class, pageable);
    }

    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public Downloadable exportOutcomeByDesign(ExportType exportType, Integer inspectionDesign, String outcome, Pageable pageable) {
        Map params = new HashMap(2);

        params.put("inspectionDesign", inspectionDesign);
        params.put("outcome", outcome);

        return queryExecutor.exportNamedQueryData("OutcomeByDesign", params, exportType, OutcomeByDesignResponse.class, pageable);
    }
    ...
    public Page<SearchWithFormTitleResponse> executeSearchWithFormTitle(Integer municipalityId, Boolean publicRead, Boolean municipalityInternalForm, String formTitle, Pageable pageable) {
        ...
        params.put("municipalityId", municipalityId);
        params.put("publicRead", publicRead);
        params.put("municipalityInternalForm", municipalityInternalForm);
    ...
    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public Downloadable exportSearchWithFormTitle(ExportType exportType, Integer municipalityId, Boolean publicRead, Boolean municipalityInternalForm, String formTitle, Pageable pageable) {
        Map params = new HashMap(4);
    ...
    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public InputStream getPhotoContentForSearchUsersByEmailOrName(String searchString) throws EntityNotFoundException {
        Map params = new HashMap(1);

        params.put("searchString", searchString);

        SearchUsersByEmailOrNameResponse _result =  queryExecutor.executeNamedQuery("searchUsersByEmailOrName", params, SearchUsersByEmailOrNameResponse.class);
        if(_result.getPhoto() == null) {
            LOGGER.debug("Blob content not exists for photo in query searchUsersByEmailOrName");
            throw new BlobContentNotFoundException("Blob content not found for photo in query searchUsersByEmailOrName");
        }
        return new ByteArrayInputStream(_result.getPhoto());
    }
    ...
    public Page<InspectorManagerByMunicipalityResponse> executeInspectorManagerByMunicipality(Integer municipalityId, String roleName, Pageable pageable) {
        ...
        return queryExecutor.executeNamedQuery("InspectorManagerByMunicipality", params, InspectorManagerByMunicipalityResponse.class, pageable);
    }

    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public Downloadable exportInspectorManagerByMunicipality(ExportType exportType, Integer municipalityId, String roleName, Pageable pageable) {
        Map params = new HashMap(2);
    ...
    public Page<CountAssignedInspectionsBetweenDatesResponse> executeCountAssignedInspectionsBetweenDates(Boolean isClosed, Integer municipality, Integer assignedTo, LocalDateTime startDate, LocalDateTime endDate, Pageable pageable) {
        ...
        return queryExecutor.executeNamedQuery("countAssignedInspectionsBetweenDates", params, CountAssignedInspectionsBetweenDatesResponse.class, pageable);
    }
    ...
    public Downloadable exportCountAssignedInspectionsBetweenDates(ExportType exportType, Boolean isClosed, Integer municipality, Integer assignedTo, LocalDateTime startDate, LocalDateTime endDate, Pageable pageable) {
        ...
        return queryExecutor.exportNamedQueryData("countAssignedInspectionsBetweenDates", params, exportType, CountAssignedInspectionsBetweenDatesResponse.class, pageable);
    }
    ...
    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public InputStream getLogoContentForEmployeesOrAdminsMunicipalities(Integer user, String role) throws EntityNotFoundException {
        Map params = new HashMap(2);

        params.put("user", user);
        params.put("role", role);

        EmployeesOrAdminsMunicipalitiesResponse _result =  queryExecutor.executeNamedQuery("EmployeesOrAdminsMunicipalities", params, EmployeesOrAdminsMunicipalitiesResponse.class);
        if(_result.getLogo() == null) {
            LOGGER.debug("Blob content not exists for logo in query EmployeesOrAdminsMunicipalities");
            throw new BlobContentNotFoundException("Blob content not found for logo in query EmployeesOrAdminsMunicipalities");
        }
        return new ByteArrayInputStream(_result.getLogo());
    }
    ...
    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public InputStream getCoiContentForAdminVendorsList(Integer user) throws EntityNotFoundException {
        Map params = new HashMap(1);

        params.put("user", user);

        AdminVendorsListResponse _result =  queryExecutor.executeNamedQuery("AdminVendorsList", params, AdminVendorsListResponse.class);
        if(_result.getCoi() == null) {
            LOGGER.debug("Blob content not exists for coi in query AdminVendorsList");
            throw new BlobContentNotFoundException("Blob content not found for coi in query AdminVendorsList");
        }
    ...
    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public Page<GetFormCountForGisRecordResponse> executeGetFormCountForGisRecord(Boolean isCase, Long gisRecordId, Pageable pageable) {
        Map params = new HashMap(2);

        params.put("isCase", isCase);
        params.put("gisRecordId", gisRecordId);

        return queryExecutor.executeNamedQuery("getFormCountForGisRecord", params, GetFormCountForGisRecordResponse.class, pageable);
    }

    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public Downloadable exportGetFormCountForGisRecord(ExportType exportType, Boolean isCase, Long gisRecordId, Pageable pageable) {
        Map params = new HashMap(2);

        params.put("isCase", isCase);
        params.put("gisRecordId", gisRecordId);

        return queryExecutor.exportNamedQueryData("getFormCountForGisRecord", params, exportType, GetFormCountForGisRecordResponse.class, pageable);
    }
    ...
    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public InputStream getPhotoContentForGetRolesForMunicipality(String role, Integer municipality) throws EntityNotFoundException {
        Map params = new HashMap(2);

        params.put("role", role);
        params.put("municipality", municipality);

        GetRolesForMunicipalityResponse _result =  queryExecutor.executeNamedQuery("GetRolesForMunicipality", params, GetRolesForMunicipalityResponse.class);
        if(_result.getPhoto() == null) {
            LOGGER.debug("Blob content not exists for photo in query GetRolesForMunicipality");
            throw new BlobContentNotFoundException("Blob content not found for photo in query GetRolesForMunicipality");
        }
        return new ByteArrayInputStream(_result.getPhoto());
    }
    ...
    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public InputStream getCoiContentForVendorsLinkedWithForm(String relatedFormGuid) throws EntityNotFoundException {
        Map params = new HashMap(1);

        params.put("RelatedFormGUID", relatedFormGuid);

        VendorsLinkedWithFormResponse _result =  queryExecutor.executeNamedQuery("VendorsLinkedWithForm", params, VendorsLinkedWithFormResponse.class);
        if(_result.getCoi() == null) {
            LOGGER.debug("Blob content not exists for coi in query VendorsLinkedWithForm");
            throw new BlobContentNotFoundException("Blob content not found for coi in query VendorsLinkedWithForm");
        }
        return new ByteArrayInputStream(_result.getCoi());
    }
    ...
    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public Page<GiscontactsOfFormResponse> executeGISContactsOfForm(String relatedFormGuid, Pageable pageable) {
        Map params = new HashMap(1);

        params.put("relatedFormGUID", relatedFormGuid);

        return queryExecutor.executeNamedQuery("GISContactsOfForm", params, GiscontactsOfFormResponse.class, pageable);
    }

    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public Downloadable exportGISContactsOfForm(ExportType exportType, String relatedFormGuid, Pageable pageable) {
        Map params = new HashMap(1);

        params.put("relatedFormGUID", relatedFormGuid);

        return queryExecutor.exportNamedQueryData("GISContactsOfForm", params, exportType, GiscontactsOfFormResponse.class, pageable);
    }
    ...
    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public Page<InspectionDesign> executeInspectionDesignForCategoriesMappedToForms(Integer formTypeId, Boolean active, Pageable pageable) {
        Map params = new HashMap(2);
    ...
    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public Downloadable exportInspectionDesignForCategoriesMappedToForms(ExportType exportType, Integer formTypeId, Boolean active, Pageable pageable) {
        Map params = new HashMap(2);
    ...
    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public Page<SearchAllFormsByVendorResponse> executeSearchAllFormsByVendor(Integer vendorId, Integer municipalityId, Integer formcategoryId, Integer formtypeId, Boolean closed, Boolean municipalityInternalForm, Boolean publicRead, Timestamp startd, Timestamp endd, Pageable pageable) {
    ...
    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public Downloadable exportSearchAllFormsByVendor(ExportType exportType, Integer vendorId, Integer municipalityId, Integer formcategoryId, Integer formtypeId, Boolean closed, Boolean municipalityInternalForm, Boolean publicRead, Timestamp startd, Timestamp endd, Pageable pageable) {
        Map params = new HashMap(9);
    ...
    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public Page<FormsTaggedWithGisrecordsResponse> executeFormsTaggedWithGISRecords(Boolean codeEnforcement, Integer gisrecordId, Pageable pageable) {
        Map params = new HashMap(2);
    ...
    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public Downloadable exportFormsTaggedWithGISRecords(ExportType exportType, Boolean codeEnforcement, Integer gisrecordId, Pageable pageable) {
        Map params = new HashMap(2);
    ...
    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public InputStream getLogoContentForAdminsMunicipalities(Integer user) throws EntityNotFoundException {
        Map params = new HashMap(1);

        params.put("user", user);

        AdminsMunicipalitiesResponse _result =  queryExecutor.executeNamedQuery("AdminsMunicipalities", params, AdminsMunicipalitiesResponse.class);
        if(_result.getLogo() == null) {
            LOGGER.debug("Blob content not exists for logo in query AdminsMunicipalities");
            throw new BlobContentNotFoundException("Blob content not found for logo in query AdminsMunicipalities");
        }
        return new ByteArrayInputStream(_result.getLogo());
    }
    ...
    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public InputStream getLogoContentForStandardUserMunicipalites(Integer user) throws EntityNotFoundException {
        Map params = new HashMap(1);

        params.put("USER", user);

        StandardUserMunicipalitesResponse _result =  queryExecutor.executeNamedQuery("StandardUserMunicipalites", params, StandardUserMunicipalitesResponse.class);
        if(_result.getLogo() == null) {
            LOGGER.debug("Blob content not exists for logo in query StandardUserMunicipalites");
            throw new BlobContentNotFoundException("Blob content not found for logo in query StandardUserMunicipalites");
        }
        return new ByteArrayInputStream(_result.getLogo());
    }
    ...
    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public Page<FormsByCategoryResponse> executeFormsByCategory(Integer formCategory, Boolean isActive, Boolean municipalityInternalForm, Pageable pageable) {
        Map params = new HashMap(3);
    ...
    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public Downloadable exportFormsByCategory(ExportType exportType, Integer formCategory, Boolean isActive, Boolean municipalityInternalForm, Pageable pageable) {
        Map params = new HashMap(3);
    ...
    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public Page<SearchAllFormsByAddressResponse> executeSearchAllFormsByAddress(Boolean codeEnforcement, Integer gisrecordId, Integer municipalityId, Integer formcategoryId, Integer formtypeId, Boolean closed, Boolean municipalityInternalForm, Boolean publicRead, Timestamp startd, Timestamp endd, Pageable pageable) {
    ...
    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public Downloadable exportSearchAllFormsByAddress(ExportType exportType, Boolean codeEnforcement, Integer gisrecordId, Integer municipalityId, Integer formcategoryId, Integer formtypeId, Boolean closed, Boolean municipalityInternalForm, Boolean publicRead, Timestamp startd, Timestamp endd, Pageable pageable) {
        Map params = new HashMap(10);
    ...
    public Page<FormFeesForUsersAndSharedResponse> executeFormFeesForUsersAndShared(Integer creatorUser, Boolean allowPayment, String paidStatus, Integer sharedWithUser, Integer municipalityId, Pageable pageable) {
        ...
        return queryExecutor.executeNamedQuery("FormFeesForUsersAndShared", params, FormFeesForUsersAndSharedResponse.class, pageable);
    }
    ...
    public Downloadable exportFormFeesForUsersAndShared(ExportType exportType, Integer creatorUser, Boolean allowPayment, String paidStatus, Integer sharedWithUser, Integer municipalityId, Pageable pageable) {
        ...
        return queryExecutor.exportNamedQueryData("FormFeesForUsersAndShared", params, exportType, FormFeesForUsersAndSharedResponse.class, pageable);
    }
    ...
    public Page<CountOfCxcodeSetsGlobalResponse> executeCountOfCXCodeSetsGlobal(Pageable pageable) {
        ...
        return queryExecutor.executeNamedQuery("CountOfCXCodeSetsGlobal", params, CountOfCxcodeSetsGlobalResponse.class, pageable);
    }

    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public Downloadable exportCountOfCXCodeSetsGlobal(ExportType exportType, Pageable pageable) {
        Map params = new HashMap(0);


        return queryExecutor.exportNamedQueryData("CountOfCXCodeSetsGlobal", params, exportType, CountOfCxcodeSetsGlobalResponse.class, pageable);
    }
    ...
    public Page<AssignedInspectionsBetweenDatesResponse> executeAssignedInspectionsBetweenDates(Boolean isClosed, Integer municipality, Integer assignedTo, LocalDateTime startDate, LocalDateTime endDate, Pageable pageable) {
        ...
        return queryExecutor.executeNamedQuery("assignedInspectionsBetweenDates", params, AssignedInspectionsBetweenDatesResponse.class, pageable);
    }
    ...
    public Downloadable exportAssignedInspectionsBetweenDates(ExportType exportType, Boolean isClosed, Integer municipality, Integer assignedTo, LocalDateTime startDate, LocalDateTime endDate, Pageable pageable) {
        ...
        return queryExecutor.exportNamedQueryData("assignedInspectionsBetweenDates", params, exportType, AssignedInspectionsBetweenDatesResponse.class, pageable);
    }
    ...
    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public InputStream getLogoContentForEmployeesMunicipalities(Integer user) throws EntityNotFoundException {
        Map params = new HashMap(1);

        params.put("user", user);

        EmployeesMunicipalitiesResponse _result =  queryExecutor.executeNamedQuery("EmployeesMunicipalities", params, EmployeesMunicipalitiesResponse.class);
        if(_result.getLogo() == null) {
            LOGGER.debug("Blob content not exists for logo in query EmployeesMunicipalities");
            throw new BlobContentNotFoundException("Blob content not found for logo in query EmployeesMunicipalities");
        }
        return new ByteArrayInputStream(_result.getLogo());
    }
    ...
    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public InputStream getLogoContentForMunicipalitiesByVendorStatus(Integer vendorId, String approvalStatus) throws EntityNotFoundException {
        Map params = new HashMap(2);

        params.put("vendorId", vendorId);
        params.put("approvalStatus", approvalStatus);

        MunicipalitiesByVendorStatusResponse _result =  queryExecutor.executeNamedQuery("municipalitiesByVendorStatus", params, MunicipalitiesByVendorStatusResponse.class);
        if(_result.getLogo() == null) {
            LOGGER.debug("Blob content not exists for logo in query municipalitiesByVendorStatus");
            throw new BlobContentNotFoundException("Blob content not found for logo in query municipalitiesByVendorStatus");
        }
        return new ByteArrayInputStream(_result.getLogo());
    }
    ...
    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public Downloadable exportSearchAllFormsByUser(ExportType exportType, Integer sharedWithUser, Integer municipalityId, Integer formcategoryId, Integer formtypeId, Boolean publicRead, Boolean municipalityInternalForm, Boolean closed, Timestamp startd, Timestamp endd, Pageable pageable) {
        Map params = new HashMap(9);
    ...
    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public Page<CountOfMunicipalityCodeListResponse> executeCountOfMunicipalityCodeList(Integer municipalityId, Pageable pageable) {
        Map params = new HashMap(1);

        params.put("MunicipalityId", municipalityId);

        return queryExecutor.executeNamedQuery("countOfMunicipalityCodeList", params, CountOfMunicipalityCodeListResponse.class, pageable);
    }

    @Transactional(readOnly = true, value = "cx2TransactionManager")
    @Override
    public Downloadable exportCountOfMunicipalityCodeList(ExportType exportType, Integer municipalityId, Pageable pageable) {
        Map params = new HashMap(1);
