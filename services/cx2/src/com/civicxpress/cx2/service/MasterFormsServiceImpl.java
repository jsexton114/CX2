...
public class MasterFormsServiceImpl implements MasterFormsService {
    ...
    private WMGenericDao<MasterForms, Integer> wmGenericDao;

    public void setWMGenericDao(WMGenericDao<MasterForms, Integer> wmGenericDao) {
	...
	@Override
	public MasterForms getById(Integer masterformsId) throws EntityNotFoundException {
    ...
    @Transactional(readOnly = true, value = "cx2TransactionManager")
	@Override
	public MasterForms findById(Integer masterformsId) {
        LOGGER.debug("Finding MasterForms by id: {}", masterformsId);
	...
	public MasterForms update(MasterForms masterForms) throws EntityNotFoundException {
        ...
        Integer masterformsId = masterForms.getId();
    ...
    @Transactional(value = "cx2TransactionManager")
	@Override
	public MasterForms delete(Integer masterformsId) throws EntityNotFoundException {
