...
public interface Cx2QueryExecutorService {
    ...
    InputStream getPhotoContentForSearchUsersByEmailOrName(String searchString) throws EntityNotFoundException;
    ...
    InputStream getLogoContentForEmployeesOrAdminsMunicipalities(Integer user, String role) throws EntityNotFoundException;
    ...
    InputStream getCoiContentForAdminVendorsList(Integer user) throws EntityNotFoundException;
    ...
    InputStream getPhotoContentForGetRolesForMunicipality(String role, Integer municipality) throws EntityNotFoundException;
    ...
    InputStream getLogoContentForAdminsMunicipalities(Integer user) throws EntityNotFoundException;
    ...
    InputStream getLogoContentForStandardUserMunicipalites(Integer user) throws EntityNotFoundException;
    ...
    InputStream getLogoContentForEmployeesMunicipalities(Integer user) throws EntityNotFoundException;
    ...
    InputStream getLogoContentForMunicipalitiesByVendorStatus(Integer vendorId, String approvalStatus) throws EntityNotFoundException;
