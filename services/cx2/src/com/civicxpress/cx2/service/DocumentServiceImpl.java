...
public class DocumentServiceImpl implements DocumentService {
    ...
    private WMGenericDao<Document, BigInteger> wmGenericDao;

    public void setWMGenericDao(WMGenericDao<Document, BigInteger> wmGenericDao) {
	...
	@Override
	public Document getById(BigInteger documentId) throws EntityNotFoundException {
    ...
    @Transactional(readOnly = true, value = "cx2TransactionManager")
	@Override
	public Document findById(BigInteger documentId) {
        LOGGER.debug("Finding Document by id: {}", documentId);
    ...
    @Transactional(value = "cx2TransactionManager")
	@Override
	public Document delete(BigInteger documentId) throws EntityNotFoundException {
