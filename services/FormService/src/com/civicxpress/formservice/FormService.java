...
public class FormService {
    ...
    private void sendStatusUpdateMail(String formGuid, Long formStatusId, String formLink) throws MessagingException, SQLException {
     ...
     private void sendOnZeroStatusUpdateMail(String formGuid, Long formStatusId, String formLink, Connection cx2Conn) throws MessagingException, SQLException {
    ...
    public void setFormStatus(String formGuid, Long formStatusId, String comments, String formLink) throws SQLException, MessagingException {
       ...
       public void setOnZeroFormStatus(String formGuid, Long formStatusId, String comments, String formLink, Connection cx2Conn) throws SQLException, MessagingException {
