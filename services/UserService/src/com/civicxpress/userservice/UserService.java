...
public class UserService {
    ...
    public void saveAdditionalImage(MultipartFile photo[], Long municipalityId, Long userId) throws Exception { // TODO: Move me
    	...
    	DBUtils.simpleQuery(cx2Conn, "INSERT INTO [Document] ([Mimetype], [MunicipalityId], [Filename], [Contents], [CreatedBy]) VALUES ('image/png', :municipalityId, 'image.png', :newPhoto, :userId)", queryParams);
    	cx2Conn.close();
    }
