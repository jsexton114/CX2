...
package com.civicxpress.inspectionmessagingmailservice;
...
//import com.civicxpress.inspectionmessagingmailservice.model.*;
 ...
 */
@ExposeToClient
public class InspectionMessagingMailService {

    private static final Logger logger = LoggerFactory.getLogger(InspectionMessagingMailService.class);
    ...
    public String sendMessagingMail(String sender,String comments,String username ,String recipient,String municipality,String inspectionType,String municipalitySignature,String inspectionTitle,String inspectionLink) throws MessagingException {
     ...
     ArrayList recipientList= new ArrayList(Arrays.asList(recipient.split(",")));
        ...
        String emailSubject="New Message on CivicXpress inspection "+inspectionTitle;
        
        String inspectionURL= inspectionLink;
        logger.info(inspectionLink);
        
        String emailContent = "You have been tagged by "+sender+" on the following message (on "+municipality+" inspection ";
        emailContent = emailContent+"<a href ='"+inspectionURL+"'>"+inspectionTitle+"</a>):";
        ...
        emailContent = emailContent+"<a href ='"+inspectionURL+ "'>Click Here</a>";
         
        emailContent = emailContent+" to view the inspection and write a message.";
